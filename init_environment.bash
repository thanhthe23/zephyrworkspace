...
# Add west auto complettion
west completion bash >> ~/.bashrc
source ~/.bashrc

# Install the segger jlink tools
wget https://www.segger.com/downloads/jlink/JLink_Linux_x86_64.tgz --post-data="accept_license_agreement=accepted" -O JLink_Linux_x86_64.tgz
tar -xvf JLink_Linux_x86_64.tgz
sudo mkdir /opt/SEGGER
sudo mv JLink_Linux_x86_64 /opt/SEGGER/JLink
rm -rf JLink_Linux_*
